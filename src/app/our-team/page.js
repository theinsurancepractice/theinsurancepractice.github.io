    ...
    <div className="team-members">
      <div className="team-member">
        <div className="team-member-top">
          <Image src={tanTzeTingAleathea} alt="Tan Tze Ting Aleathea" className="team-member-photo" />
      ...
      <div className="team-member">
        <div className="team-member-top">
          <Image src={bensonTan} alt="Benson Tan" className="team-member-photo" />
          <div className="team-member-divider"></div>
      ...
      <div className="team-member">
        <div className="team-member-top">
          <Image src={samuelChew} alt="Samuel Chew" className="team-member-photo" />
          <div className="team-member-divider"></div>
      ...
      <div className="team-member">
        <div className="team-member-top">
          <Image src={shaneTanLongKiat} alt="Shane Tan Long Kiat" className="team-member-photo" />
          <div className="team-member-divider"></div>
      ...
      <div className="team-member">
        <div className="team-member-top">
          <Image src={brandonTan} alt="Brandon Tan" className="team-member-photo" />
          <div className="team-member-divider"></div>
