  ...
  <div className="insurance container">
    ...
    <div className="insurance-group">
      <div className="insurance-types">
        <NavLink to="/products/personal-insurance/travel" end className="insurance-type">
          <img src={cartoonTravel} alt="Travel" />
          <h4>Travel</h4>
        </NavLink>
        <NavLink to="/products/personal-insurance/domestic-worker" end className="insurance-type">
          <img src={cartoonDomesticWorker} alt="Domestic Worker" />
          <h4>Domestic Worker</h4>
        </NavLink>
        <NavLink to="/products/personal-insurance/golfer" end className="insurance-type">
          <img src={cartoonGolfer} alt="Golfer" />
          <h4>Golfer</h4>
        </NavLink>
        <NavLink to="/products/personal-insurance/pet" end className="insurance-type">
          <img src={cartoonPet} alt="Pet" />
          <h4>Pet</h4>
        </NavLink>
        <NavLink to="/products/personal-insurance/fire" end className="insurance-type">
          <img src={cartoonFire} alt="Fire" />
          <h4>Fire</h4>
        </NavLink>
        <NavLink to="/products/personal-insurance/medical-plans" end className="insurance-type">
          <img src={cartoonMedicalPlans} alt="Medical Plans" />
          <h4>Medical Plans</h4>
        </NavLink>
        <NavLink to="/products/personal-insurance/personal-accident" end className="insurance-type">
          <img src={cartoonPersonalAccident} alt="Personal Accident" />
          <h4>Personal Accident</h4>
        </NavLink>
        <NavLink to="/products/personal-insurance/motor" end className="insurance-type">
